...
import { Copy, InfoIcon, Loader2, X } from "lucide-react";
...
export default function RehearsalCard({
  ...
  return (
    <div className="border border-[#3A3F4A] rounded-lg p-4 lg:p-10 bg-[#2A2F3A]">
      <div className="flex lg:flex-row flex-col gap-6 ">
        ...
        <div className="flex flex-col md:flex-row gap-4 md:gap-6">
          ...
          <div className="shrink-0 w-full md:w-auto">
            <div
              className={`
                        relative w-full md:w-120 h-56 rounded-lg overflow-hidden ${
            ...
            >
              ...
              {!isPlaying && (
                ...
                >
                  <button className="w-14 h-14 md:w-16 md:h-16 bg-white/90 hover:bg-white rounded-full flex items-center justify-center transition-all hover:scale-110">
                    <svg
                      className="w-7 h-7 md:w-8 md:h-8 text-slate-800 ml-1"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
              ...
              {/* Title + Feedback */}
              <div className="absolute top-3 left-3 right-3 z-20 max-w-[calc(100%-1.5rem)]">
                <h4 className="text-[14px] md:text-[15px] font-semibold text-white mb-0.5 drop-shadow-lg truncate">
                  {title?.split(" ")[0]} #{title?.split(" ")[1] || "1"}
                </h4>
                <p className="text-[10px] md:text-[11px] text-white/90 drop-shadow-lg truncate">
                  {peerFeedbackCount} Peer Feedback Received
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="flex-1 flex flex-col">
          <div className="flex flex-col">
            ...
            <div className="flex justify-end lg:mb-8 mb-4">
              {/* PROCESSING Status */}
            ...
            <div className="mt-auto space-y-3">
              {/* Action Buttons */}
              <div className="flex md:flex-row items-start flex-col md:justify-end md:items-center gap-3">
                <Link
                  ...
                  className="px-6 py-2.5 bg-[#68AD5C] hover:bg-green-700 text-white text-[13px] font-medium rounded-md transition-colors"
                >
                  View Feedback
                </Link>
                ...
                <button
                  ...
                  disabled={isDeleting}
                  className="px-6 py-2.5 bg-[#68AD5C] hover:bg-green-700 text-white text-[13px] font-medium rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 cursor-pointer"
                >
